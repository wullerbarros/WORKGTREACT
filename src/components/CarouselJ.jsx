...
import ImagemTenis from '../assets/img/img-header/tênis.svg';
...
function CarouselJ() {
  ...
  return (
    <section className="bg-gray-100 flex flex-col items-center justify-center font-inter">
            ...
            <div key={index} className="flex">
              <div className="w-1/2 flex flex-col justify-center pt-10 pl-20 pr-45">
                ...
                <a
                  ...
                  className="bg-[#C92071] text-white h-[48px] w-[220px] rounded-[8px] inline-flex items-center justify-center hover:bg-pink-500"
                >
                  {slide.buttonText}
                </a>
              </div>
              <div className="w-1/2 flex flex-col items-center justify-end relative">
                ...
                <img
                  src={slide.topImage}
                  alt="Logo Superior"
                  className="absolute mt-[200px] mb-[463px] mr-[37px] ml-[500px] w-[140px] h-[140px] object-contain"
                />
              </div>
            </div>
          ))}
